const apiUrl = "https://it4409-crud-student-20215664.onrender.com";
let students = []
let currentPage = 1
const pageSize = 3
...
async function fetchStudents() {
    const response = await fetch("https://it4409-crud-student-20215664.onrender.com");
...
async function deleteStudent(id) {
    await fetch(`${"https://it4409-crud-student-20215664.onrender.com"}/${id}`, { method: 'DELETE' });
    await fetchStudents();
}
